...
covergroup AHB5_cov_grp;
    hresetn_cp : coverpoint AHB5_seq_item.rst_n { 
        bins hresetn0 = {0};
        bins hresetn1 = {1};
    }
    slv_hsel_cp : coverpoint AHB5_seq_item.slv_sel {
        bins slv_closed = {0};
        bins slv_opened = {1};
    }
    slv_hready_cp : coverpoint AHB5_seq_item.slv_enable {
        bins slv_ready0 = {0};
        bins slv_ready1 = {1};
    }
    haddr_cp : coverpoint AHB5_seq_item.address {
        bins memory_slv_addr[] = {0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60};
    }
    hburst_cp : coverpoint AHB5_seq_item.burst {
        bins hburst_values[] = {SINGLE, INCR, WRAP4, INCR4, WRAP8, INCR8, WRAP16, INCR16};
    }
    hsize_cp : coverpoint AHB5_seq_item.size {
        bins hsize_values[] = {BYTE, HALFWORD, WORD};
    }
    hwrite_cp : coverpoint AHB5_seq_item.write {
        bins hread = {READ};
        bins hwrite = {WRITE};
    }
    hstrb_cp : coverpoint AHB5_seq_item.strb {
        bins one_hot_strb[] = {4'b1000, 4'b0100, 4'b0010, 4'b0001};
        bins strb0 = {0};
        bins strb1 = {4'b1111};
    }
    hrdata_cp : coverpoint AHB5_seq_item.rdata {
        bins zero = {32'b0};
        bins max = {32'hFFFFFFFF};
        bins typical = {[32'h1:32'hFFFFFFFE]};
    }
    hreadyout_cp : coverpoint AHB5_seq_item.valid {
        bins hreadyout0 = {0};
        bins hreadyout1 = {1};
    }
    hresp_cp : coverpoint AHB5_seq_item.trans_error {
        bins okay = {0};
        ignore_bins error = {1};
    }
endgroup
