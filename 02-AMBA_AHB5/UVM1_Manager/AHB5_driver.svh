...
virtual task drive (AHB5_sequence_item AHB5_seq_item);
    if (AHB5_seq_item.HWRITE == WRITE)
        AHB5_vif.write(AHB5_seq_item.HRESETn, AHB5_seq_item.HSELx, AHB5_seq_item.HREADY, AHB5_seq_item.HADDR, AHB5_seq_item.HBURST, AHB5_seq_item.HSIZE, AHB5_seq_item.HTRANS, AHB5_seq_item.HWDATA, AHB5_seq_item.HWSTRB);
    else if (AHB5_seq_item.HWRITE == READ)
        AHB5_vif.read(AHB5_seq_item.HRESETn, AHB5_seq_item.HSELx, AHB5_seq_item.HREADY, AHB5_seq_item.HADDR, AHB5_seq_item.HBURST, AHB5_seq_item.HSIZE, AHB5_seq_item.HTRANS, AHB5_seq_item.HWSTRB);
endtask
