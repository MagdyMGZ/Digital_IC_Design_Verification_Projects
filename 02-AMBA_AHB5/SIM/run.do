vlib work
# UVM1 Model The Master Only (BFM & Seq)
vlog -f src_files_UVM1.list +cover -covercells +define+SIM
# UVM2 Model The Master (BFM) and AHB Interconnect Matrix Bus (Seq)
# vlog -f src_files_UVM2.list +cover -covercells +define+SIM
