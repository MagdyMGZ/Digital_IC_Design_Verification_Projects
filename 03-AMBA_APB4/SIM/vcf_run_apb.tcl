# Formal Signoff - APB4 - 2 Slaves
# vcf -gui -f vcf_run_apb.tcl
# Appmode
set_fml_appmode FPV 
set_fml_var fml_fta_seq_debug true
# Design Setting
set design APB4_BUS_WRAPPER
...
# Compute FC Analysis
compute_formal_core
# signoff_check -effort low -time 12H -signoff_bound -1 -signoff_dashboard  # COI + OC
